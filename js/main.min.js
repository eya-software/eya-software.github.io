...
function() {
    ...
    if (t.length > 0)
        for (let a = 0; a < t.length; a++) {
            ...
            u[r].classList.add("is-active"), i(0, c), window.addEventListener("resize", function() {
                i(0, c)
            });
            let m = !1;
...
function() {
    ...
    if (e.length > 0)
        for (let n = 0; n < e.length; n++) {
            ...
            s.data = JSON.parse(s.el.getAttribute("data-price-input")), s.currentValEl = i.querySelector(".pricing-slider-value"), s.thumbSize = parseInt(window.getComputedStyle(s.currentValEl).getPropertyValue("--thumb-size"), 10);
